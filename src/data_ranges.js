...
export function guided_split(dimensions, simple_ranges, par_coords, weights, suggestions, linear_par_coords, extreme_par_coords) {
    let computed_ranges = {}
    for (let dimension of dimensions) {
        par_coords.update_single_dimension_ranges(dimension, [...simple_ranges[dimension]])
        let metrics_without_split = compute_metrics(par_coords, linear_par_coords, extreme_par_coords)
        ...
        while (improving) {
            ...
            for (let suggested_split_pos of suggestions[dimension]) {
                ...
                let metrics_dim = compute_metrics_dim(par_coords, dimension, linear_par_coords, extreme_par_coords)
                let current_metrics = {}
    ...
    return {
        ...
        metrics: compute_metrics(par_coords, linear_par_coords, extreme_par_coords)
    }
}
