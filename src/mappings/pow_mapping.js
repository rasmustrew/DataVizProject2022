...
export default class PowMapper {
    ...
    constructor(input_space_ranges, output_range, exponent) {
        ...
        this.d3_scale = d3.scalePow().domain([this.input_start, this.input_end]).range(output_range).exponent(exponent)
    }
    map(input) {
